<template>
	<el-main class="bg edit_wrap auth">
...
<script>
	...
	export default {
      ...
      get_obj_after(json, func){
        if (this.form.path.replace('/'+this.form.table_name+'/','')=='table'){
          this.mod_name_show = this.form.mod_name+'后台列表'
        }
        if (this.form.path.replace('/'+this.form.table_name+'/','')=='view'){
          this.mod_name_show = this.form.mod_name+'后台详情'
        }
        if (this.form.path.replace('/'+this.form.table_name+'/','')=='list'){
          this.mod_name_show = this.form.mod_name+'前台列表'
        }
        if (this.form.path.replace('/'+this.form.table_name+'/','')=='details'){
          this.mod_name_show = this.form.mod_name+'前台详情'
        }
        if (this.form.path.replace('/'+this.form.table_name+'/','')=='edit'){
          this.mod_name_show = this.form.mod_name+'前台编辑'
        }
      },
			// 获取用户列表
