<template>
	...
	<el-row class="rows row2">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/classification_information/table','set') || $check_action('/classification_information/view','set') || $check_action('/classification_information/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
