<template>
	...
	<el-row class="rows row2">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/customized_products/table','set') || $check_action('/customized_products/view','set') || $check_action('/customized_products/view','get') || $check_action('/定制/table','add') || $check_action('/定制/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/customized_products/table','set') || $check_action('/customized_products/view','set') || $check_action('/customized_products/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="e-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/i_want_to_customize/view')" v-if="user_group == '管理员' || $check_action('/i_want_to_customize/table','add') || $check_action('/i_want_to_customize/view','add')">
						<span>定制</span>
					</el-button>
									<router-link v-if="user_group == '管理员' || $check_comment('/customized_products/table')" class="e-button el-button--small is-plain el-button--primary"
