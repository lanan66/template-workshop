<template>
	<el-main class="bg table_wrap exam_question">
				...
				<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
					<el-col :xs="24" :sm="12" :lg="12" class="search_btn_1 btns">
							...
							<!-- <router-link v-if="user_group == '管理员' || $check_action('/exam/table','add')" class="el-button float-right el-button--default el-button--primary search_btn_add"
								:to="'/question_view/view?exam_id='+query.exam_id"><span>添加</span>
							</router-link> -->
							<el-button  v-if="user_group == '管理员' || $check_action('/exam/table','add')" class="float-right  search_btn_add" @click="$router.push('/question_view/view?exam_id='+query.exam_id)">添加</el-button>
