<template>
  <el-main class="bg table_wrap exams_db">
    <el-form
      ...
      <el-row class="rows row2">
        <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
          <el-col :xs="24" :sm="12" :lg="12" class="search_btn_1 btns">
              ...
              <el-button
                v-if="
                  user_group == '管理员' || $check_action('/exam_question_database/table', 'del')
                "
              ...
              <!-- <router-link
                v-if="
                  user_group == '管理员' || $check_action('/exam_question_database/table', 'add')
                "
                class="el-button float-right el-button--default el-button--primary search_btn_add"
                to="./view?"
                ><span>添加</span>
              </router-link> -->
              <el-button  v-if="user_group == '管理员' || $check_action('/exam_question_database/table', 'add')" class="float-right  search_btn_add" @click="$router.push('./view?')">添加</el-button>
      ...
      <el-table-column fixed="right" label="操作" width="180">
        <template slot-scope="scope">
          ...
          <router-link
            ...
            v-if="user_group == '管理员' || $check_action('/exam_question_database/table', 'set')"
