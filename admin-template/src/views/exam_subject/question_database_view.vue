      ...
      <el-col :xs="24" :sm="24" :lg="24" class="el_form_btn_warp">
          <el-form-item>
            ...
            >
              <el-button
                v-if="
                  $check_action('/exam_question_database/view', 'set')
                "
...
export default {
  ...
  data() {
    return {
      ...
      url_add: "~/api/exam_question_database/add?",
      url_set: "~/api/exam_question_database/set?",
      url_get_obj: "~/api/exam_question_database/get_obj?",
      url_upload: "~/api/exam_question_database/upload?",
