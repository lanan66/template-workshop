<template>
  <el-main class="bg table_wrap exan_subject">
    <el-form
      ...
      <el-row class="rows row2">
          <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
            <el-col :xs="24" :sm="12" :lg="12" class="search_btn_1 btns">
                ...
                <el-button
                  v-if="
                    user_group == '管理员' || $check_action('/subject/table', 'del')
                  "
                ...
                <el-button  v-if="user_group == '管理员' || $check_action('/subject/table', 'add')" class="float-right  search_btn_add" @click="$router.push('./view?')">添加</el-button>
      ...
      <el-table-column fixed="right" label="操作" width="200">
        <template slot-scope="scope">
          ...
          <router-link
            ...
            v-if="
              user_group == '管理员' || $check_action('/subject/view', 'set')
            "
