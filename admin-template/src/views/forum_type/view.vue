<template>
	<el-main class="bg edit_wrap forum_type">
...
<script>
	...
	export default {
		...
		data() {
			return {
				field: "type_id",
				url_add: "~/api/forum_type/add?",
				url_set: "~/api/forum_type/set?",
				url_get_obj: "~/api/forum_type/get_obj?",
				url_upload: "~/api/forum_type/upload?",
