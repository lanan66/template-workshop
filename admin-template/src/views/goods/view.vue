		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
						...
						<!-- 商城中心 -->
			<diy_mall_center v-if="form.source_table === 'mall_center'" :query="{mall_center_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_mall_center>
...
<script>
	import mixin from "../../mixins/page.js";
				import diy_mall_center from "../../components/diy/diy_mall_center.vue";
