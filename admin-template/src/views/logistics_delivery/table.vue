      ...
      <el-row class="rows row2">
        ...
        <el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
          ...
          <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
            ...
            <el-button v-if="user_group == '管理员' || $check_action('/logistics_delivery/view', 'del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
        ...
        <template slot-scope="scope">
          <div class="view_a">
            <button class="e-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                    ...
                    size="small" v-if="user_group == '管理员' || $check_action('/logistics_delivery/view', 'get') || $check_action('/logistics_delivery/view', 'set')">
              <span>详情</span>
            </button>
            <button v-if="scope.row['signing_status'] == '待签收' && (user_group=='管理员' || $check_option('/logistics_delivery/table','sign_for'))"
