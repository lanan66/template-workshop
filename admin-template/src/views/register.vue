				...
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<el-form-item label="头像" prop="avatar">
							<el-upload id="avatar" class="avatar-uploader" drag
						...
						<el-form-item label="身份" prop="user_group">
							...
							<!-- 商城用户 -->
						<form_mall_users v-if="form.user_group === '商城用户'" :form="form_sub" ></form_mall_users>
								<!-- 卖家 -->
						<form_seller v-if="form.user_group === '卖家'" :form="form_sub" ></form_seller>
