		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="店铺名称" prop="store_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','store_name')) || (!form_sub['seller_id'] && $check_field('add','store_name'))"></el-input>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/seller/view','set') || $check_action('/seller/view','add')">
