            ...
            <div class="col-12">
              <div class="my_header">
                ...
                <div class="conton-top">
                  <router-link to="/">
                  <div class="logo">该项目为测试项目（用于演示或测试）</div>
                  </router-link>
                    ...
                    <li class="nav_li">
                      <router-link to="/" class="nav_a">
                        首页
                                              ...
                                              <li>
                          <router-link v-if="$check_action('/forum/list','get')" to="/forum/list">
                              交流论坛
                          </router-link>
                        </li>
                                                                    <li class="nav_li">
                          <router-link v-if="$check_exam('/exam/list','answers')" to="/exam/list" class="nav_a">
                              在线考试
                          </router-link>
                        </li>
                      
                                              <li class="nav_li">
                          <router-link v-if="$check_action('/subject_exam/table','answers')" to="/subject_exam/list" class="nav_a">
                            考试管理
                          </router-link>
                        </li>
                          ...
                          <router-link to="/article/list" class="nav_a">
                            {{$page_title("/article/list") || "新闻通知"}}
                                                                    ...
                                                                    <li class="nav_li">
                          <router-link to="/message/list" v-if="$check_action('/message/list','get')" class="nav_a">
                              测试留言板
                          </router-link>
                        </li>
                                                                    <li class="nav_li">
