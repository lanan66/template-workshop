	...
	<div class="diy_details_box diy_div_customized_products">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																											<button class="btn btn-primary details_btn" v-if="$check_action('/i_want_to_customize/edit','add')" @click="to_form('/i_want_to_customize/edit')" ><span> 定制</span> </button>
																											<button class="btn btn-primary details_btn" v-if="$check_action('/customized_products/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/customized_products/details','set')" @click="change_collect()" ><span>收藏</span></button>
											</div>
						<!-- 富文本 -->
