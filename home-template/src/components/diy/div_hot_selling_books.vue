<template>
	<div class="diy_details_box diy_div_hot_selling_books">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																<button class="btn btn-primary details_btn" v-if="$check_action('/hot_selling_books/details','set')" @click="change_praise()" ><span>点赞</span></button>
																<button class="btn btn-primary details_btn" v-if="$check_action('/hot_selling_books/details','set')" @click="change_collect()" ><span>收藏</span></button>
												<router-link :to="'../novel_chapters/read?novel_reading_id=' + obj.hot_selling_books_id">
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var hot_selling_books_id = this.obj.hot_selling_books_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "hot_selling_books",
          source_field: "hot_selling_books_id",
          source_id: hot_selling_books_id
        }, (res) => {
