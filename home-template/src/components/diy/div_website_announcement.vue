<template>
	<div class="diy_details_box diy_div_website_announcement">
		<div class="warp diy_warp">
			...
			<div class="details_btn_wrap">
																<button class="btn btn-primary details_btn" v-if="$check_action('/website_announcement/details','set')" @click="change_praise()" ><span>点赞</span></button>
															</div>
						<!-- 富文本 -->
