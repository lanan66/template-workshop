<template>
	<div class="diy_form">
			<b-form-group v-if="$check_register_field('add','store_name','/seller/view')" id="input-group-${idx}" label="店铺名称" label-for="input-${idx}">
			<b-form-input id="input-${idx}" v-model="form['store_name']" type="text" placeholder="店铺名称" trim></b-form-input>
		</b-form-group>
		</div>
</template>
