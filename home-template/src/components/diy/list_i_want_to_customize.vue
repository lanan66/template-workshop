	...
	<div class="diy_home diy_list diy_i_want_to_customize" id="diy_i_want_to_customize_list">
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
									<th class="diy_title" v-if="$check_field('get','purchase_quantity','/i_want_to_customize/list')">
					购买数量
				</th>
										<th class="diy_title" v-if="$check_field('get','price','/i_want_to_customize/list')">
					价格
				</th>
											<th class="diy_title" v-if="$check_field('get','mall_users','/i_want_to_customize/list')">
					商城用户
				</th>
																	</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
										<td class="diy_field diy_number" v-if="$check_field('get','purchase_quantity','/i_want_to_customize/list')">
						<span>
							{{ o["purchase_quantity"] }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','price','/i_want_to_customize/list')">
						<span>
							{{ o["price"] }}
						</span>
					</td>
												<td class="diy_field diy_uid" v-if="$check_field('get','mall_users','/i_want_to_customize/list')">
						<span>
							{{ get_user_name('mall_users',o['mall_users']) }}
						</span>
					</td>
																	</tr>
			</table>
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/i_want_to_customize/details?i_want_to_customize_id="+v.i_want_to_customize_id)
			},
			get_user_name(name,id){
				var obj = null;
					...
					obj = this.list_user_seller.getObj({"user_id":id});
									...
									if (name == 'mall_users'){
					obj = this.list_user_mall_users.getObj({"user_id":id});
				}
															var ret = "";
				if(obj){
