    ...
    <el-form label-position="right" :model="query" class="form p_4" label-width="120">
      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
            ...
            <el-button v-if="user_group == '管理员' || $check_action('/mall_center/table','add') || $check_action('/mall_center/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                                                      ...
                                                                      <router-link v-if="user_group == '管理员' || $check_comment('/mall_center/table')" class="el-button el-button--small is-plain el-button--primary"
