<template>
	<div class="diy_details page_hot_selling_books" id="hot_selling_books_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_hot_selling_books'>
							<div_hot_selling_books :obj="obj"></div_hot_selling_books>
...
<script>
	import div_hot_selling_books from "@/components/diy/div_hot_selling_books.vue";
		...
		methods:{
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.hot_selling_books_id;
				}
			},
			/**
			 * 初始化收藏状态
