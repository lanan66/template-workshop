<template>
	<div class="page_root" id="root_demo">
		            ...
		            <div class="col-12">
		                <div class="sw_no">
							...
							<div class="card_notice">
								<div class="notice_title">关于我们 <router-link to="notice/list" class="not_more more"><span class="mor">更多</span></router-link></div>
								<!-- 公告组件 -->
		...
		<!-- 推荐定制商品模块(结束) -->
								<!-- 推荐网站公告模块(开始) -->
		<div class="ins warp model2" v-if="$check_action('/website_announcement/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/website_announcement/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 网站公告推荐列表组件 -->
						<div class="list_website_announcement_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_website_announcement :list="list_website_announcement" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
		...
		<!-- 推荐网站公告模块(结束) -->
						<!-- 推荐热卖图书模块(开始) -->
		<div class="ins warp model3" v-if="$check_action('/hot_selling_books/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/hot_selling_books/list" class="ins_more more">
		                            <span calss="mor">更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 热卖图书推荐列表组件 -->
						<div class="list_hot_selling_books_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_hot_selling_books :list="list_hot_selling_books" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
	...
	export default {
		...
		methods: {
		   ...
		   this.chatList.length && (reallyTime =	nowTimeChuo - this.chatList[this.chatList.length-1]['nowTime'] > spaceTime ?  nowTime : "");
			...
			get_website_announcement() {
				let url = "~/api/website_announcement/get_list?";
								// url = "~/api/website_announcement/get_list?orderby=hits desc";
								this.$get(url, {
									"orderby": "hits desc",
							"page": 1,
					"size": 12
			...
			get_hot_selling_books() {
				let url = "~/api/hot_selling_books/get_list?";
										url = "~/api/hot_selling_books/get_hits_list?";
						this.$get(url, {
		...
		computed: {
		        ...
		        return list_table;
						    ...
						    list_table_hot_selling_books() {
		        var list = this.list_website_announcement;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_website_announcement.map((o) => {
		                // 第二个中括号是对象的属性
		                list_table[i][o] = list[i][o] || "";
		            });
		        }
		        return list_table;
				    ...
				    list_table_hot_selling_books() {
		        var list = this.list_hot_selling_books;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_hot_selling_books.map((o) => {
		                // 第二个中括号是对象的属性
		                list_table[i][o] = list[i][o] || "";
		            });
		        }
