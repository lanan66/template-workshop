				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 商城中心 -->
							<div><span>商城中心</span></div>
							<view_mall_center v-if="$check_action('/mall_center/table','get')"></view_mall_center>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_mall_center from "../../components/diy/view_mall_center.vue";
	export default {
		data() {
			return {
			};
