<template>
  <div class="page_exam subject_list" id="exam_list">
            ...
            <div class="exam_list_content">
              <table stripe>
                ...
                <tr v-for="o in list" :key="o">
                  ...
                  <td>
                    <router-link
                      :to="'/subject_exam/details?exam_id=' + o.exam_id"
                      class="answer_link"
                      v-if="
                        answered_list[o.exam_id] &&
                        $check_action('/subject_exam/list', 'get')
                      "
                    >
                      <span>查看分数</span>
                    </router-link>
                    <router-link
                      ...
                      v-else-if="
                        o.status === '启用' &&
                        $check_action('/subject_exam/list', 'answers')
                      "
                    >
                      <span>答题</span>
                    </router-link>
