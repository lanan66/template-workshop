<template>
	<div class="diy_details page_website_announcement" id="website_announcement_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_website_announcement'>
							<div_website_announcement :obj="obj"></div_website_announcement>
...
<script>
	import div_website_announcement from "@/components/diy/div_website_announcement.vue";
		...
		methods:{
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.website_announcement_id;
				}
			},
			/**
			 * 获取点赞
