						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<uni-forms-item class="user_group" name="user_group" label="身份">
									...
									<!-- 商城用户 -->
								<form_mall_users v-if="form.user_group === '商城用户'" @change="handleSubFormChange" :form="form_sub" ></form_mall_users>
										<!-- 卖家 -->
								<form_seller v-if="form.user_group === '卖家'" @change="handleSubFormChange" :form="form_sub" ></form_seller>
...
<script>
	import mixin from "@/libs/mixins/page.js"
		/* 商城用户 */
	import form_mall_users from "@/components/diy/form_mall_users";
			/* 卖家 */
	import form_seller from "@/components/diy/form_seller";
