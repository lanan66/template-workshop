<template>
  <view class="page_classification_information diy_table diy_table_tml" id="classification_information_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="商品类别" name="product_category">
                      <uni-easyinput type="text" v-model="query.product_category" placeholder="商品类别" />
                    </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/classification_information/view?" v-if="user_group == '管理员' || $check_action('/classification_information/table','add') || $check_action('/classification_information/view','add')">添加</navigator>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-if="user_group == '管理员' || $check_action('/classification_information/table','del') || $check_action('/classification_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/classification_information/view?' + field + '=' + o[field]"
						v-if="user_group == '管理员' || $check_action('/classification_information/table','set') || $check_action('/classification_information/view','set') || $check_action('/classification_information/view','get')" class="btn btn-primary">详情</navigator>
					                                        									</view>
			</view>
		</view>
	</view>
