<template>
  <view class="page_customized_products diy_table diy_table_tml" id="customized_products_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="商品名称" name="product_name">
                      <uni-easyinput type="text" v-model="query.product_name" placeholder="商品名称" />
                    </uni-forms-item>
                                          <uni-forms-item label="是否特价" name="is_it_a_special_offer">
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/customized_products/view?" v-if="user_group == '管理员' || $check_action('/customized_products/table','add') || $check_action('/customized_products/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','inventory')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>库存</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','attachment')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>附件</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','remarks')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>备注</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','production_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>生产时间</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','date')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>日期</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','is_it_a_special_offer')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>是否特价</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','product_category')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>商品类别</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-if="user_group == '管理员' || $check_action('/customized_products/table','del') || $check_action('/customized_products/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/customized_products/view?' + field + '=' + o[field]"
						v-if="user_group == '管理员' || $check_action('/customized_products/table','set') || $check_action('/customized_products/view','set') || $check_action('/customized_products/view','get')" class="btn btn-primary">详情</navigator>
					                                        																		<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/i_want_to_customize/view','add')" @click="to_form('/pages/i_want_to_customize/view',o)">
									<span>定制</span>
								</a>
																						</view>
			</view>
	...
	export default {
		...
		data() {
			return {
                ...
                list_user_seller: [],
                                                        // 是否特价列表
                list_is_it_a_special_offer: [{value:"",text:"全部"}],
                            // 商品类别列表
