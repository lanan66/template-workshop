					...
					<view class="col-12 col-6">
						<view class="view">
							...
							<view class="diy_field diy_text">
								<span>
									<image style="width:5rem;height: 5rem;border: 1px #d1d1d1 solid;"
										:src="$fullImgUrl(obj.img)" mode="scaleToFill"
	...
	export default {
		...
		methods: {
			...
			submit_main() {
				...
				_slef.$post(_slef.url_set + '?forum_id=' + form.forum_id, form, function(json, status) {
					uni.showToast({
						icon: 'success',
						title: '保存成功',
					});
