			...
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索品牌" @confirm="search_" @cancel="cancel" cancelText="取消"
											@input="input($event, 'brand')">
		...
		<!-- 列表 -->
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','brand')" class="col">
						<view class="view">
							...
							<view class="diy_title" v-if="true">
								...
								<text>
									{{ get_user_seller(o['seller']) }}
													...
													<view v-if="0 && $check_field('get','mall_tags')" class="col">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>商城标签</span>
							</view>
