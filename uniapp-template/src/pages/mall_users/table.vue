<template>
  <view class="page_mall_users diy_table diy_table_tml" id="mall_users_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="姓名" name="name">
                      <uni-easyinput type="text" v-model="query.name" placeholder="姓名" />
                    </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/mall_users/view?" v-if="user_group == '管理员' || $check_action('/mall_users/table','add') || $check_action('/mall_users/view','add')">添加</navigator>
                            ...
                            <span>姓名</span>
								...
								<text>
									{{ o["name"] }}
													...
													<view v-if="0 && $check_field('get','age')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>年龄</span>
                          </view>
								...
								<text>
									{{ o["age"] }}
													...
													<view v-if="0 && $check_field('get','gender')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>性别</span>
                          </view>
                            ...
                            <span>类别</span>
								...
								<text>
									{{ o["category"] }}
													...
													<view v-if="0 && $check_field('get','resume')" class="col">
						<view class="view">
                          <view class="diy_title" v-if=" false">
                            <span>简历</span>
                          </view>
											<view class="diy_field diy_img">
								<img :src="$fullUrl(o['resume'])" />
							</view>
										</view>
					</view>
                            ...
                            <span>备注</span>
								...
								<text>
									{{ o["remarks"] }}
													...
													<view v-if="0 && $check_field('get','tag_recommendation')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>标签推荐</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-if="user_group == '管理员' || $check_action('/mall_users/table','del') || $check_action('/mall_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/mall_users/view?' + field + '=' + o[field]"
                               v-if="user_group == '管理员' || $check_action('/mall_users/table','set') || $check_action('/mall_users/view','set') || $check_action('/mall_users/view','get')" class="btn btn-primary">详情</navigator>
	            					</view>
				</view>
			</view>
		</view>
